...
import cn.osworks.aos.system.dao.mapper.Act_re_procdefMapper;
...
public class ProcDeployService {
	...
	public List<Dto> listProcs(Dto inDto){
		...
		for (ProcessDefinition processDefinition : processDefinitions) {
			...
			Act_re_procdefPO act_re_procdefPO = act_re_procdefMapper.selectByKey(processDefinition.getId());
			dto.put("dgrm_resource_name_", act_re_procdefPO.getDgrm_resource_name_());
			dto.put("suspension_state_", String.valueOf(act_re_procdefPO.getSuspension_state_()));
	...
	public Dto deployProcess(Dto inDto) throws IOException, XMLStreamException {
		...
		Act_re_procdefPO act_re_procdefPO = new Act_re_procdefPO();
		act_re_procdefPO.setId_(processDefinition.getId());
		act_re_procdefPO.setCategory_(AOSCons.OSWORKS_WEBSITE);
		//act_re_procdefPO.updateByKey(act_re_procdefPO);
