 ...
 */
 ...
 package cn.osworks.aos.system.modules.controller.workflow.rest.editor;
...
public class ProcessInstanceHighlightsResource {
  ...
  @Autowired
	...
	@RequestMapping(value="service/process-instance/{processInstanceId}/highlights", method = RequestMethod.GET, produces = "application/json")
