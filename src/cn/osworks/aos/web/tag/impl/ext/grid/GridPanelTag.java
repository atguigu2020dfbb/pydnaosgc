...
public class GridPanelTag extends PanelTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		tagDto.put("drag", getDrag());
		tagDto.put("previewPlugin", getPreviewPlugin());
		tagDto.put("bodyField", getBodyField());
	...
	public String getPreviewPlugin() {
		return previewPlugin;
	}

	public void setPreviewPlugin(String previewPlugin) {
