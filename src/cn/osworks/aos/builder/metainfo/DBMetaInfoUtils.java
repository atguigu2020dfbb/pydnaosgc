...
//			String aa = StringUtils.upperCase(databaseMetaData.getUserName());
//			ResultSet rs = databaseMetaData.getColumns(null, StringUtils.upperCase(databaseMetaData.getUserName()), equalTableName, null);
			ResultSet rs = databaseMetaData.getColumns(null, "%", equalTableName, null);
			while (rs.next()) {
				ColumnVO columnVO = new ColumnVO();
				//获取不到是不是自动增长列 identity
//				String bb = rs.getString("IDENTITY");
