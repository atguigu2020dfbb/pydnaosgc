...
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="_g_module" url="listModules.jhtml" region="center" hidePagebar="true" bodyBorder="1 0 0 0"
			...
			<aos:column header="数据表" dataIndex="tablename" width="120" />
	...
	<aos:window id="_w_module" title="新增功能模块菜单">
		<aos:formpanel id="_f_module" width="400" layout="anchor" labelWidth="65">
			...
			<aos:combobox fieldLabel="关联表" emptyText="请选择..." id="relate_table_url" allowBlank="false" onchang="_c_url">
			<aos:option value="1" display="是"/>
			<aos:option value="0" display="否"/>
			</aos:combobox>
			<aos:textfield name="url_" fieldLabel="主页面URL" maxLength="100" />
			<aos:combobox fieldLabel="数据表" name="tablename"  editable="false" columnWidth="0.5" url="listComboBoxData.jhtml" />
				...
				AOS.reset(_f_module_u);
 				...
 				if(record){
 					_w_module_u.show();
 	 				...
 	 				_f_module_u.down('[name=tablename]').setValue(record.data.tablename);
 	 			    //根节点不允许修改上级节点字段
