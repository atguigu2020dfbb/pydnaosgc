...
<aos:onready>
	<aos:viewport layout="fit">
		<aos:gridpanel id="_g_print" url="listAccounts1.jhtml"
			onrender="_g_print_query" pageSize="10">
			<aos:docked>
				<aos:dockeditem xtype="tbtext" text="打印目录信息" />
				<aos:dockeditem text="新增" id="add" icon="add2.png" onclick="_w_print_show" />
				<aos:dockeditem text="隐藏"  id="ycc" icon="del.png" onclick="_w_print_show3" />
				<aos:dockeditem text="修改" icon="edit2.png" onclick="_w_print_u_show" />
				<aos:dockeditem text="删除" icon="del2.png" onclick="_g_print_del" />
				...
				<aos:triggerfield emptyText="内容" id="nrzy"
					...
					<aos:triggerfield id="tablename" width="200" value="${tablename }" disabled="false"/>
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column header="流水号" dataIndex="id_" hidden="true" />
			<aos:column header="内容摘要" dataIndex="tm" width="160" minWidth="80"
			...
			<aos:column header="审核" dataIndex="sh" rendererFn="fn_button_render2" width="40" />
			<aos:column header="领导审批" dataIndex="tg" rendererFn="fn_button_render3" width="40" />
		</aos:gridpanel>
	</aos:viewport>
	...
	<script type="text/javascript">
		...
		function fn_button_render2(value, metaData, record, rowIndex, colIndex,
			...
			return '<input type="button" value="审核" class="cbtn" onclick="_fn_check();" />';
		}
