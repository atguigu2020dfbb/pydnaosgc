...
Ext.define('Ext.ux.uploadPanel.UploadPanel',{
    ...
    columns : 
    	...
    	[
        {xtype: 'rownumberer'},
        {text:'流水号', width: 100, hidden:true, dataIndex: 'pid'},
        {text:'主表号', width: 100, hidden:true, dataIndex: 'tid'},
    ...
    store : Ext.create('Ext.data.Store',{
    	...
    	fields : ['pid','tid','name','type','size','percent','status','fileName']
    }),
    addFileBtnText : 'Add File',
    uploadBtnText : 'Upload',
    deleteBtnText : 'deletePath',
        ...
        this.dockedItems = [{
            ...
            items: [
                ...
                { 
                	...
                	itemId : 'downBtn',
                	iconCls : 'down',
                	text : this.downBtnText,
                	scope : this,
                	handler : this.onDownPath
                },{ xtype: 'tbseparator' },{
                	xtype : 'button',
                	itemId : 'cancelBtn',
                	iconCls : 'cancel',
